...
enhancer_start = int(float(options.start.strip()))
...
for line in open_input.readlines(): # for each line in the input file
        ...
        value = abs(position - enhancer_start) # compute the absolute value of the difference between position and enhancer_start

        if value < x: # if this absolute value is lower than maximumDistance
                x = value # this value will now be your current maximumDistance
